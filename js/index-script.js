...
--------------------------------------------------------------*/
    $('.fun-fact .container .row').each(function () {
        ...
        $this.appear(function() {
            $('#happy-clients').animateNumber({ number: 100 }, 2000);
            $('#awards').animateNumber({ number: 20 }, 2000);
            $('#coffee').animateNumber({ number: 100 }, 2000);
            $('#works').animateNumber({ number: 100000 }, 2000);
        });
    });
